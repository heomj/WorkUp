        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 1px solid #eef0f2;">
            ...
            <div style="display: flex; gap: 16px; font-size: 0.8rem; color: #566a7f; font-weight: 700;">
                <span style="display: flex; align-items: center; gap: 6px;">
                    <span style="display: inline-block; width: 8px; height: 8px; border-radius: 50%; background-color: #ff8276;"></span> 중요도 높음
                </span>
                <span style="display: flex; align-items: center; gap: 6px;">
...
<script>
    ...
    function goToCreateChat(empId, empNm) {
        ...
        AppAlert.confirm('채팅방 연결', `<b>\${empNm}</b>님과의 채팅방으로 이동하시겠습니까?`, '대화하기', '취소', 'chat', 'primary') // (알람 리팩토링)
            .then((result) => {
            ...
            <div class="kb-card" data-id="\${task.taskNo}" data-progress="\${task.taskPrgrt}" style="\${imptBorderStyle}">
                <div class="kb-card-body" style="display: flex; justify-content: space-between; align-items: flex-start;">
                    ...
                    <div style="display: flex; align-items: center; gap: 2px;">
                        \${editBtnHtml}
                        <button onclick="openDetailModal(\${task.taskNo})" style="border: 1px solid #e4e6ef; background: #f8f9fa; color: #566a7f; border-radius: 4px; padding: 2px 6px; font-size: 0.7rem; font-weight: bold; cursor: pointer; flex-shrink: 0;">
                            상세
                        </button>
                    </div>
                </div>
