            ...
            <div class="tab-pane fade show active" id="internal">
                <form action="/email/send" method="post" enctype="multipart/form-data" id="sendMailForm">
                    ...
                    <div class="mb-3"><label class="form-label fw-bold" >제목&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        ...
                        <input type="text" class="form-control" id="write-subject" name="emlTtl"/>
            ...
            <div class="tab-pane fade" id="external">
                <form action="/email/sendExternal" method="post" enctype="multipart/form-data" id="extsendMailForm">
                    ...
                    <div class="mb-3"><label class="form-label fw-bold" >제목&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        ...
                        ></div>
                    <div class="mb-3">
                        <label class="form-label fw-bold" for="extmultipartFiles">첨부파일</label>
                        <div class="input-group">
                            <input
                                    type="file"
                                    class="form-control"
                                    id="extmultipartFiles"
                                    name="multipartFiles"
                                    multiple
                            />
                        </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        clearMailCookies()
        let str = `안녕하세요, 유아름님.
            프로젝트 '알파'의 이번 주 진행 상황을 공유드립니다.

            진행률: 65% (목표 대비 5% 초과 달성)

        주요 완료 사항: 백엔드 API 연동 최적화 및 UI/UX 수정본 배포

        이슈 사항: 외부 API 연동 지연으로 인한 QA 일정 일부 조정 필요

        상세 내용은 첨부된 파일을 확인 부탁드립니다. 다음 주 월요일 오전 10시에 관련 회의를 진행하고자 하니 일정 확인 부탁드립니다.
