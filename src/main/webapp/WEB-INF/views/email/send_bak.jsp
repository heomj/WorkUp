...
<style>
    ...
    /* 이하 수신자 확인 모달 및 테이블 스타일 */
    /* table-hover를 사용 중이라면, tr의 배경색까지 잡아줘야 합니다 */
    ...
    /* 특정 모달에만 적용할 클래스 */
    .modal-right-align .modal-dialog {
        margin-left: auto;   /* 왼쪽 마진을 최대로 (오른쪽으로 밀림) */
        margin-right: 300px;  /* 오른쪽 벽에서 50px만큼 띄우기 */
        max-width: 300px;    /* 모달 너비가 너무 커지지 않게 제한 */
    }
</style>
<!-- 리스트 -->
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <div class="input-group input-group-sm" style="width: 250px;">
                ...
                <button class="btn btn-outline-primary d-inline-flex align-items-center" id="btnSearch"><span class="material-icons fs-6">search</span></button>
            </div>
            <a class="btn btn-primary btn-sm d-flex align-items-center" href="/email/write">
    ...
    <div class="dashboard-card mb-3">
        <div class="p-2 d-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex align-items-center gap-3 ps-2">
                ...
                <button class="btn btn-sm btn-light border text-secondary d-inline-flex align-items-center" onclick="handleMailAction('isDelete')"><span
                        class="material-icons fs-6 v-align-middle">history</span> 회수 및 삭제
                </button>
    ...
    <div class="dashboard-card p-4">
        <div class="border-bottom pb-3 mb-3">
            ...
            <div class="d-flex align-items-center">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=mail" class="rounded-circle me-2" width="40">
                <div>
        ...
        <div id="detail-content" class="py-4" style="min-height: 200px; line-height: 1.6;"></div>
    </div>
</div>
...
// ---  CC 전용 그리드 (너비를 40px로 고정하여 제목 시작 위치를 통일) ---
            ...
            } else {html += '<span class="badge bg-secondary" style="font-size: 0.65rem; padding: 2px 4px; vertical-align: middle;">내부</span>';}
            html += '</div>';
...
// 1. 제목 영역
            ...
            html += '<div class="flex-grow-1 text-truncate px-2'+titleallRcvrNullhtml+'"style="max-width: 1080px;' + (item.emlEmrgYn==='Y' ? ' color:red;"' : '"') + '>';
...
//받은 사람 (수신인)
            if(item.emailReceiverVOList.length>1){
                ...
                html += `<div class="text-end text-muted small pe-2 ms-4 text-truncate" style="width:150px;">`
                html += `<button class="btn btn-sm btn-light border text-secondary d-inline-flex align-items-center"
                            onclick="openRecipientModal(\${item.emlNo})">수신확인</button></div>`;
...
/*        const data = {"emlNo": emlNo}
        ...
        <div class="attachment-box">
            ...
            document.getElementById('detail-sender').innerText = mail.empNm;
            ...
            //보낸 메일함은 답장 기능이 없다
                ...
                +'&nbsp;&nbsp;<button class="btn btn-success btn-sm" onclick="showWriteView()">전달</button>';
            //회수가능시에만 보이게 하기
                document.getElementById('detail-content').innerHTML +=
